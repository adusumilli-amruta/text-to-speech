...
export default function GenerateSoundView() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen container">
      <div className="w-full md:w-2/5 p-4 one">
      ...
      <div className="w-full md:w-2/5 p-4 bg-gray-200 h-screen two">
